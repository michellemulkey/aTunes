 ...
 *
 */
public class ID3v1_1TagReader extends TagReader {
	...
	protected Tag retrieveTag(AudioFile file) throws IOException {
		...
		if (tagHeader.equalsIgnoreCase("TAG")) {
			...
			String comment = getField(tagBytes, 97, 29);
			int trackNumber = tagBytes[126];
			...
			tag.setTrackNumber(trackNumber != 32 ? trackNumber : 0);
			tag.setGenre(genre);
